...
The HTTP checker covers registration, CSRF rejection, session renewal, guest-cart migration, seller photo upload, UPI and net-banking payment, accepted terms, unlocked seller contact, wrong/correct pickup codes, verified handover, review unlocking, cart clearing, competing buyers and waitlist alerts, prohibited-item rejection, invalid-payment rollback, removing items referenced in carts, logout, public pages and image availability.
